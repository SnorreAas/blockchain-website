...
<template>
  <div>
    ...
    <div class="connect">
      <a href="https://twitter.com/ClassyFoxClub" target="_blank" class="share twitter" :style="{ backgroundImage: 'url(' + twitter + ')' }">
        <svg role="presentation" class="svg--icon">
          <use xlink:href="#svg--twitter" />
        </svg>
        <span class="clip">TWITTER</span>
      </a>
      <a href="https://discord.gg/sZjqgm3zfv" target="_blank" class="share github" :style="{ backgroundImage: 'url(' + discord + ')' }">
        <svg role="presentation" class="svg--icon">
